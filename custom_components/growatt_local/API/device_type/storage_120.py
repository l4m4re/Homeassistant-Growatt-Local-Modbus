...
from ...ems_types import decode_priority_word
from .base import (
...
STORAGE_HOLDING_REGISTERS_120_TL_XH: tuple[GrowattDeviceRegisters, ...] = (
    ...
    GrowattDeviceRegisters(
        name=ATTR_GRID_FIRST_DISCHARGE_RATE,
        register=3036,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_GRID_FIRST_STOP_SOC,
        register=3037,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_1_START,
        register=3038,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_1_END,
        register=3039,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_2_START,
        register=3040,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_2_END,
        register=3041,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_3_START,
        register=3042,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_3_END,
        register=3043,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_4_START,
        register=3044,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_4_END,
        register=3045,
        value_type=int,
        read_write=True,
    ),
    ...
    GrowattDeviceRegisters(
        name=ATTR_BATTERY_FIRST_STOP_SOC,
        register=3048,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_5_START,
        register=3050,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_5_END,
        register=3051,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_6_START,
        register=3052,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_6_END,
        register=3053,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_7_START,
        register=3054,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_7_END,
        register=3055,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_8_START,
        register=3056,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_8_END,
        register=3057,
        value_type=int,
        read_write=True,
    ),
    GrowattDeviceRegisters(
        name=ATTR_XH_SCHEDULE_9_START,
        register=3058,
        value_type=int,
        read_write=True,
    ),
...
STORAGE_INPUT_REGISTERS_120_TL_XH: tuple[GrowattDeviceRegisters, ...] = (
    ...
    GrowattDeviceRegisters(
        name=ATTR_CURRENT_PRIORITY,
        register=3144,
        value_type=custom_function,
        function=decode_priority_word,
    ),
)
